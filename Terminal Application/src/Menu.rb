...
class MenuControl
    ...
    def company_list
        system ("clear")
        puts Rainbow("~The color of company names represents their industry~").bg(:magenta)
        puts "(Information is provided by ASX official website)"
        puts "\n"
        prompt.enum_select("Company-List: (Please input numbers and press 'Enter')") do |company_list|
...
#-----------------------------------------------------------------------------------------------------------------------------------
    ...
    def portfolio_status
        ...
        prompt.select('') do |back|
            ...
            puts Rainbow("Hint: Investment allocation pie-chart is not available until you have shares on hand!").red.bright
            puts "\nAvailable deposits: $#{@available_deposit}"
